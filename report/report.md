...
The best configuration — $\alpha = 0.01$ (among tied values), `n_bins=7`, quantile binning — achieves a test accuracy of **80.33%** and a macro F1 of **0.8001**. 5-fold cross-validation on the training set gave **81.14% ± 1.78%**, with per-fold values ranging from 78.38% to 83.67%.
